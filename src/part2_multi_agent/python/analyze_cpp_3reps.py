...
files = [
    DATA_DIR / "cpp_rep01.csv",
    DATA_DIR / "cpp_rep02.csv",
    DATA_DIR / "cpp_rep03.csv",
]
...
out_csv = DATA_DIR / "cpp_mean_3reps.csv"
...
plt.title("Partie 2 (C++) — Moyenne sur 3 réplications")
plt.legend()
plt.tight_layout()

out_fig = FIG_DIR / "cpp_mean_3reps.png"
